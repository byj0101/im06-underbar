(function() {
  ...
  _.last = function(array, n) {
    return n === undefined ? array[array.length-1] : n>array.length-1 ? array : array.slice(array.length-n, array.length);
  };
  ...
  _.uniq = function(array) {
    var obj = {};
    _.each(array, item => {
        if(!obj.hasOwnProperty(item)) obj[item] = item;
      });
  ...
  _.memoize = function(func) {
    ...
    return function(){
      ...
      if(!cache[args]) cache[args] = func.apply(this, arguments);
      return cache[args];
    };
  };
